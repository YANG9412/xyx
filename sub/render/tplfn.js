...
export default function anonymous(it) {
  ...
  if (arr1) {
    ...
    while (index < l1) {
      ...
      out += ' ';
      // if (index) {
        out += ' <image class="frbox" src="img/WeChatRank_FriendPanel.png"><view class="listItem listItemOld">  ';
      // }
      // out += ' ';
      // if (index % 2 === 0) {
      //   out += ' <view class="listItem"><image class="frbox" src="img/WeChatRank_FriendPanel.png"> </image>';
      // }
      out += ' <text class="listItemNum" value="' + (index + 1) + '"></text> <image class="listHeadImg" src="' + (item.avatarUrl) + '"></image> <view><text class="listItemName" value="' + (item.nickname) + '"></text><text class="numbertop" value="' + (item.score) + '"></text></view><image class="gift" src="img/WeChatRank_GiftButton.png"></image></view></image> ';
    }
  }
